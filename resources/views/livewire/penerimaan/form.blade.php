    ...
    <div class="card-body">
        <form wire:submit.prevent="store">
            <div class="form-group">
                ...
                <select class="form-control" id="pembelian_id" wire:model="pembelian_id" @if($isShow) disabled @endif>
                    <option value="">Select Pembelian</option>
                    @foreach($pembelians as $pembelian)
                        <option value="{{ $pembelian->id }}">
                            Id Pembelian : {{ $pembelian->id }} - No Pembelian : {{ $pembelian->no_po }} - Tanggal : {{ $pembelian->created_at->format('d/m/Y') }}
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="no_penerimaan" placeholder="Enter No. Penerimaan" wire:model="no_penerimaan" @if($isShow) readonly @endif>
